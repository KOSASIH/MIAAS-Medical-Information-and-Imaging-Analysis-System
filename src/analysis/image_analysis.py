    ...
    for output in outputs:
        for detection in output:
            ...
            if confidence > 0.5 and classID == 0:
                ...
                objects.append({"class": "person", "confidence": confidence, "bounding_box": {"x": centerX, "y": centerY, "width": width, "height": height}})
...
async def image_classification(image: Image):
    ...
    return {"predictions": [{"class": class_names[i], "confidence": predictions[0][i]} for i in top_5_predictions]}
